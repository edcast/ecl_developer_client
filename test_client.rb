...
service.get(name: "sociative_source_1")
...
binding.pry
# update source type
source_type_id = service.response_data["data"]["id"]
service = EclDeveloperClient::SourceType.new(client_id,secret)
...
service.create(params)
service.response_data
source_id = service.response_data["data"]["id"]
...
service = EclDeveloperClient::ContentItem.new(client_id,secret)
service.create(params)
service.response_data
...
puts service.response_data

# delete content item
content_id = "007f8d65-410e-49d5-aa77-27ba87eb8576"
service  = EclDeveloperClient::ContentItem.new(client_id,secret,{organization_id: 15})
